...
<a class="navbar-brand" href="indexadm.html">GEEK STORE</a>
...
<div class="collapse navbar-collapse" id="navbarSupportedContent" style="background-color:rgb(99, 96, 96);">
    <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
            <a class="nav-link" href="indexadm.html" id="fonte">Página inicial <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item ">

        </li>
        <li class="nav-item ">
            <a class="nav-link" href="pag2adm.php" id="fonte">Produtos</a>
        </li>
        <li class="nav-item ">
